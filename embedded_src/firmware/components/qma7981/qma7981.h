...
/** I2C 配置 */
#define QMA7981_I2C_ADDR            (0x12)          /*!< I2C 地址 (ESP32-S3-EYE SUB V1.1 板载) */
#define QMA7981_I2C_FREQ            (400000)        /*!< I2C 频率 400kHz */
#define QMA7981_I2C_NUM             (I2C_NUM_0)     /*!< I2C 控制器编号 */
#define QMA7981_I2C_SDA_GPIO        (GPIO_NUM_4)    /*!< I2C SDA 引脚 (ESP32-S3-EYE SUB V1.1) */
#define QMA7981_I2C_SCL_GPIO        (GPIO_NUM_5)    /*!< I2C SCL 引脚 (ESP32-S3-EYE SUB V1.1) */

/** 中断引脚配置 */
#define QMA7981_INT_GPIO            (GPIO_NUM_7)    /*!< 中断输入引脚 */

/** 设备 ID */
#define QMA7981_DEVID_ADDR          (0x0F)          /*!< QMA7981 设备 ID 寄存器地址 */
#define QMA7981_DEVID_VALUE         (0x01)          /*!< QMA7981 设备 ID 值 */

/** ICM-42607/ICM-42688-P 设备 ID (ESP32-S3-EYE SUB V1.1 可能使用的传感器) */
#define ICM42607_DEVID_ADDR         (0x75)          /*!< ICM-42607 WHO_AM_I 寄存器 */
#define ICM42607_DEVID_VALUE        (0x42)          /*!< ICM-42607 设备 ID */
#define ICM42688P_DEVID_VALUE       (0xCB)          /*!< ICM-42688-P 设备 ID */
...
/** ICM-42607 寄存器定义 */
#define ICM42607_REG_TEMP_L         (0x0D)          /*!< 温度低字节 */
#define ICM42607_REG_TEMP_H         (0x0C)          /*!< 温度高字节 */
#define ICM42607_REG_ACC_X_L        (0x1F)          /*!< 加速度 X 低字节 */
#define ICM42607_REG_ACC_X_H        (0x1E)          /*!< 加速度 X 高字节 */
#define ICM42607_REG_GYR_X_L        (0x25)          /*!< 陀螺仪 X 低字节 */
#define ICM42607_REG_GYR_X_H        (0x24)          /*!< 陀螺仪 X 高字节 */
#define ICM42607_REG_PWR_MGMT_1     (0x4E)          /*!< 电源管理 1 */
#define ICM42607_REG_PWR_MGMT_2     (0x4F)          /*!< 电源管理 2 */
#define ICM42607_REG_CONFIG_GYRO    (0x34)          /*!< 陀螺仪配置 */
#define ICM42607_REG_CONFIG_ACCEL   (0x33)          /*!< 加速度计配置 */
